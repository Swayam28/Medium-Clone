...
export default function Posts() {
    ...
    useEffect(() => {
        ...
        getPosts().then((response) => {
            const results = response.filter(post => {
    ...
    return (
       ...
       {/* <div style={{marginTop:"-3vh"}} className="margin">  <Right/></div> */}
        <div className='post'>
            ...
            <div style={{height:"fit-content",width:"100%",display:"flex",alignItems:"center",justifyContent:"flex-start",padding:"0.5rem"}}>
                <input onChange={(e)=>setText(e.target.value)} placeholder='search title' style={{width:"80%",height:"2rem",outline:"none",padding:"0.5rem",borderBottom: '1px solid black',}} type='text'/>
